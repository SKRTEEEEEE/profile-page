import { MongooseBase, MongooseDocument, MongooseTimestamps,  } from "@/core/infrastructure/mongoose/types/index"
...
export interface TechDocument extends TechBase, MongooseTimestamps, MongooseDocument{
